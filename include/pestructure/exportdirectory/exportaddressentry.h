...
namespace pe
{
    ...
    public:
        ...
        explicit ExportDirectoryEntry(const char* pe_data, int export_address_rva, int name_pointer_rva, int biased_ordinal, std::shared_ptr<SectionTable> section_table_);
